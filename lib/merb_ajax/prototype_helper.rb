...
module Merb
  module Helpers
    ...
    # functions from Prototype using Merb, including functionality to call remote
    # Merb methods (that is, making a background request to a Merb action) using Ajax.
    ...
    # Merb::Helpers::JavaScriptHelper for more information on including
    # this and other JavaScript files in your Merb templates.)
    #
    ...
    #
    # == Designing your Merb actions for Ajax
    # When building your action handlers (that is, the Merb actions that receive your background requests), it's
    ...
    # You can turn the layout off on particular actions by calling render with the :layout => :none option:
    #
    #  render :layout => :none
    #
    ...
    #  end
    #
    # The else clause can be left off and the current action will render with full layout and template. A
    #
    ...
    #
    #  render :inline => 'Return this from my method!', :layout => :none
    #
    ...
    module PrototypeHelper
      ...
      #     :href => url(:action => "destroy", :id => post.id)
      ...
      #     url(:controller => "some", :action => "place") }
      #
      ...
      def remote_form_for(obj, *args, &block)
        options = args.extract_options!
        object_name = obj_from_ivar_or_sym(obj)

        concat(form_remote_tag(options), block.binding)
        fields_for(object_name, *(args << options), &block)
      ...
      class JavaScriptGenerator #:nodoc:
        ...
        private
          def include_helpers_from_context
            @context.extended_by.each do |mod|
              extend mod unless mod.name =~ /^Merb::Helpers/
            end
        ...
        # Merb::RenderMixin#render, then call #insert_html, #replace_html,
        ...
        module GeneratorMethods
          ...
          # of options to be passed to Merb::RenderMixin#render_js_block.  For example:
          #
          ...
          # Example:
          #
          #   # Generates: alert('This message is from Merb!')
          #   page.alert('This message is from Merb!')
          def alert(message)
            call 'alert', message
          end
          ...
          # Merb::Helpers::ScriptaculousHelper for more information.
          ...
          # or deleted.
          # See Merb::Helpers::ScriptaculousHelper for more information.
      ...
      # to Merb::Helpers::JavaScriptHelper#javascript_tag.
...
class Merb::ViewContext #:nodoc:
  include Merb::Helpers::PrototypeHelper
end